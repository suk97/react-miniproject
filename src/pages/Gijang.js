...
import GijanggunImg from "../assets/Gijanggun.png"
...
const GijanggunLogo = styled.img`   
    display:block;
    width: 40rem;
    height: 20rem;
    margin: auto;
...
const GijanggunTitle = styled.span`
    width: 17.5rem;
    height: 7.5;
    margin-left: 35rem;
    font-family: Inter;
...
const GijanggunLine = styled.div`
    width: 35rem;
    height: 2px;
...
function Gijanggun({setWishid, onAdd, wishItem, onDelete}) {
        ...
        return(
            ...
            <div>
                ...
                <Container>
                    ...
                    <FoodHeader/>
                    <GijanggunLogo src={GijanggunImg}/>
                    <GijanggunTitle>Gijang</GijanggunTitle>
                    <GijanggunLine />
                    ...
                    {foodImg.map((food, idx) => {
                            if (idx < 3) {
                                return <FoodImg src={foodImg[idx]} onClick= {() => {setPopshow(true)
