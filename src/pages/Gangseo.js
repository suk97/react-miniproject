...
import GangseguImg from "../assets/Gangsegu.png"
...
` ;
    ...
    const GangseoTitle = styled.span`
    width: 17.5rem;
    height: 7.5;
    margin-left: 33.5rem;
    font-family: Inter;
...
function Gangseo({setWishid, onAdd, wishItem, onDelete}) {
        ...
        return(
            ...
            <div>
                <Container>
                    ...
                    <FoodHeader/>
                    <GangseoLogo src={GangseguImg}/>
                    <GangseoTitle>Gangseo</GangseoTitle>
                    <GangseoLine />
