...
import SasangguImg from "../assets/sasangu.PNG"
...
const SasangguTitle = styled.span`
    width: 17.5rem;
    height: 7.5;
    margin-left: 34.7rem;
    font-family: Inter;
...
function Sasanggu({setWishid, onAdd, wishItem, onDelete}) {
        ...
        return(
            ...
            <div>
                <Container>
                    ...
                    <FoodHeader/>
                    <SasangguLogo src={SasangguImg}/>
                    <SasangguTitle>Sasang</SasangguTitle>
                    <SasangguLine />
